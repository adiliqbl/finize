...
data class ApiTransaction(
    ...
    @SerialName(AMOUNT_TO) override val amountTo: ApiMoney? = null,
    @SerialName(AMOUNT_FROM) override val amountFrom: ApiMoney? = null,
    @SerialName(AMOUNT_LOCAL) override val amountLocal: ApiMoney? = null,
...
internal class NotionApiTransaction(transaction: ApiTransaction) :
    BaseApiTransaction by transaction
